...
<html lang="en">
<head>
	<title>Dentist Assistant - Login</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			...
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="images/logo-o.png" alt="IMG">
				</div>
				...
				<form class="login100-form validate-form" action = "c_login.php" method = "post">
					...
					<center><a href="../../FrontEnd/index.php" class="nav-link"><u><b><font color = "blue">HOME</font></b></a></center>
				</form>
			</div>
		</div>
	</div>
